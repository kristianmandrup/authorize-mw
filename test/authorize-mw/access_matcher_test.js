  ...
  describe('AccessMatcher', function(){
    ...
    describe('create', function(){
      return specify('must have complex access request', function(){
        return accessMatcher.accessRequest.should.eql(requests.complex);
      });
    });
    describe('chaining', function(){
      ...
      describe('has-action calls result!', function(){
      ...
      describe('has-user calls result!', function(){
        specify('should match chaining: role(admin).action(read).has-user()', function(){
          return accessMatchers.complex.role('admin').action('read').hasUser().should.be['true'];
        });
        return specify('should match chaining: role(admin).action(read).has-user()', function(){
          return accessMatchers.userless.role('admin').action('read').hasUser().should.be['false'];
        });
      });
      return describe('has-subject calls result!', function(){
        return specify('should match chaining: role(admin).action(read).user().has-subject()', function(){
